...
class Item extends React.Component{
    ...
    componentDidMount(){
        this.setState({
            ...
            stars: Array(parseInt(this.props.rating)).fill(0) //Array para estrellas
        })
    }
                ...
                <p>
                    {
                        this.state.stars.map(x =>
                            <img src="img/star.png" width="32"/>) //Muestra una estrella el nro de veces que tenga el Array  
                    }
